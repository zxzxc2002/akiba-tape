...
const PlayerControls: React.FC<PlayerControlsProps> = ({
  ...
  return (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 bg-[#2a2a2a] p-3 rounded-xl border-t border-white/10 border-b-4 border-black/50 shadow-2xl flex items-center gap-4 z-50">
      {/* Panel Texture */}
