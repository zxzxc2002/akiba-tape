...
const RetroScreen: React.FC<RetroScreenProps> = ({ content, trackNumber, page, onPageChange }) => {
  ...
  return (
    <div className="w-full h-full bg-[#000084] border-t-2 border-white/20 p-2 font-mono text-white relative overflow-hidden flex flex-col shadow-inner">
      {/* Scanline effect */}
      ...
      {/* Main Content Area */}
      <div className="flex-1 p-2 text-[16px] leading-relaxed whitespace-pre-wrap relative z-20 font-medium overflow-y-auto">
        {content.text[page]}
