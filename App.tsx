  ...
  return (
    <div className="w-screen h-screen overflow-hidden relative flex flex-col">
      ...
      <div className={`flex-1 flex flex-col transition-all duration-1000 ease-in-out ${isLayoutSplit ? 'h-full' : 'h-full'}`}>
              ...
              {!imageError ? (
                <div className="w-full h-full overflow-hidden relative">
                  ...
                  <img
                    ...
                    className="w-[20%] h-[20%] object-cover origin-top-left scale-[5] filter blur-[0.5px] brightness-[0.6] contrast-[1.2] sepia-[0.6] opacity-70 mix-blend-screen"
                ...
                <div className="w-full h-full flex items-center justify-center text-white/50 font-mono">
                  [ IMAGE {currentTrack}:{currentPage + 1} NOT FOUND ]
                </div>
              )}
            </div>
          </div>
        ...
        {!isLayoutSplit && (
          <div className="relative h-full flex-1 transition-all duration-1000 ease-in-out">
